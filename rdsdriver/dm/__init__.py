...
def WrapAttrs(source_module_name, target_module_name, package_name=None):
    source_module = importlib.import_module(source_module_name, package_name)
...
WrapAttrs("dmPython", __name__, package_name="rdsdriver.dm")
